...
class NicePlot(object):
    ...
    def show(self, figsize=(17, 10)):
        plt.figure(figsize=figsize)
        self.plot()
        plt.show()
        
    def save(self, filename, figsize=(17, 10)):
        plt.figure(figsize=figsize)
        self.plot()
...
class ColoredScatterPlot(NicePlot):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.colorbar_kwargs = kwargs.get('colorbar_kwargs', {})
    ...
    def plot(self):
        ...
        plt.scatter(self.x_data, self.y_data, c=self.z_data,
                    ...
                    cmap=self.colormap)
        plt.colorbar(label=self.z_label, **self.colorbar_kwargs)
